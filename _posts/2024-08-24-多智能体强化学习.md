...
- 第 $i$ 个 Agent 的**策略网络**：$\pi(\textcolor{red}{a^i} | \textcolor{green}{s}; \theta^i)$
...
- 所有 Agent 的观测向量记为 $\textcolor{green}{\bm{o} = [o^1, o^2, \cdots, o^n]}$
- 所有 Agent 的动作向量记为 $\textcolor{red}{\bm{a} = [a^1, a^2, \cdots, a^n]}$
- 中央控制器知晓 $\textcolor{green}{\bm{o}}$、$\textcolor{red}{\bm{a}}$ 和所有 Agent 的奖励
- 中央控制器拥有所有 Agent 的策略网络 $\pi(\textcolor{red}{a^i} | \textcolor{green}{\bm{o}}; \theta^i)$，其中 $i = 1, 2, \cdots, n$
  - 接受所有 Agent 的观测 $\textcolor{green}{\bm{o}}$，输出第 $i$ 个 Agent 动作的分布
- 中央控制器拥有所有 Agent 的价值网络 $q(\textcolor{green}{\bm{o}}, \textcolor{red}{\bm{a}}; \omega^i)$，其中 $i = 1, 2, \cdots, n$
...
- 执行
  ...
  - 中央控制器根据所有 Agent 的观测 $\textcolor{green}{\bm{o} = [o^1, o^2, \cdots, o^n]}$ 随机抽样所有 Agent 的动作 $\textcolor{red}{a^i} \sim \pi(\textcolor{red}{\cdot} | \textcolor{green}{\bm{o}}; \theta^i)$
...
- 训练
  ...
  - 中央控制器使用所有 Agent 上传的动作、观测和奖励 $\{\textcolor{green}{o^i}, \textcolor{red}{a^i}, \textcolor{blue}{r^i}\}_{i=1}^n$ 训练所有 Agent 的价值网络 (Critic) $q(\textcolor{green}{\bm{o}}, \textcolor{red}{\bm{a}}; \omega^i)$
  - 使用 TD 算法更新价值网络参数 $\omega^i$
    - 使用所有观测 $\textcolor{green}{\bm{o} = [o^1, o^2, \cdots, o^n]}$
    - 使用所有动作 $\textcolor{red}{\bm{a} = [a^1, a^2, \cdots, a^n]}$
...
|2|Fully Centralized|$\pi(\textcolor{red}{a^i} \| \textcolor{green}{\bm{o}}; \theta^i)$|$q(\textcolor{green}{\bm{o}}, \textcolor{red}{\bm{a}}; \omega^i)$|
|3|Centralized Training <br> Decentralized Execution|$\pi(\textcolor{red}{a^i} \| \textcolor{green}{o^i}; \theta^i)$|$q(\textcolor{green}{\bm{o}}, \textcolor{red}{\bm{a}}; \omega^i)$|
